...
### 3.6：开cloudflare小黄伞
如果开小黄伞，需要走特定的几个端口，即：
飞牛——系统设置——端口设置——访问端口要设置成以下中对应的才行：
|类型|端口号|
|----|----------------------|
|HTTP端口 (回源):| 80, 8080, 8880, 2052, 2082, 2086, 2095|
|HTTPS端口 (回源):| 443, 2053, 2083, 2087, 2096, 8443|
## 4.常见问题
...
[![Stargazers over time](https://starchart.cc/dalaohuuu/fnos_acme_cf_issue.svg)](https://starchart.cc/dalaohuuu/fnos_acme_cf_issue)
